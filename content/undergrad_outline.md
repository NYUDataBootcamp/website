...
- **[THE BLOG.]({{< ref "undergrad_fall_2018_blog.md" >}})** Remember this course is a data course that uses Python. In THE BLOG, I'll discuss interesting uses of data that I find on the web and talk through various issues.
- **[My GitHub REPOSITORY](https://github.com/NYUDataBootcamp)** Here I will post notebooks from each class.
